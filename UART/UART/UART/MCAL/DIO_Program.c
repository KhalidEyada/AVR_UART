...
void DIO_voidSetPortValue(u8 Copy_u8PortId, u8 Copy_u8Value)
{
		...
		switch(Copy_u8PortId)
		{
			case DIO_u8_PORTA:  SET_PORT(DIO_u8_PORTA_REG,Copy_u8Value);     break;
			
			case DIO_u8_PORTB:  SET_PORT(DIO_u8_PORTB_REG,Copy_u8Value);     break;
			
			case DIO_u8_PORTC:  SET_PORT(DIO_u8_PORTC_REG,Copy_u8Value);     break;
			
			case DIO_u8_PORTD:  SET_PORT(DIO_u8_PORTD_REG,Copy_u8Value);     break;
...
void DIO_voidSetPortDirection(u8 Copy_u8PortId, u8 Copy_u8Direction)
{
			...
			switch(Copy_u8PortId)
			{
				case DIO_u8_PORTA:  SET_PORT(DIO_u8_DDRA_REG,Copy_u8Direction);     break;
				
				case DIO_u8_PORTB:  SET_PORT(DIO_u8_DDRB_REG,Copy_u8Direction);     break;
				
				case DIO_u8_PORTC:  SET_PORT(DIO_u8_DDRC_REG,Copy_u8Direction);     break;
				
				case DIO_u8_PORTD:  SET_PORT(DIO_u8_DDRD_REG,Copy_u8Direction);     break;
